...
UserProgress _userProgressDeserialize(
  ...
  final object = UserProgress(
    ...
    id: id,
    questId: reader.readString(offsets[1]),
...
extension UserProgressQueryFilter
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterFilterCondition> uuidEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterFilterCondition> uuidLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterFilterCondition> uuidBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterFilterCondition> uuidEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterFilterCondition> uuidContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterFilterCondition> uuidMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension UserProgressQuerySortBy
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterSortBy> sortByQuestId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'questId', Sort.asc);
    });
  }

  QueryBuilder<UserProgress, UserProgress, QAfterSortBy> sortByQuestIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterSortBy> sortByUuid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.asc);
    });
  }

  QueryBuilder<UserProgress, UserProgress, QAfterSortBy> sortByUuidDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProgressQuerySortThenBy
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterSortBy> thenByQuestId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'questId', Sort.asc);
    });
  }

  QueryBuilder<UserProgress, UserProgress, QAfterSortBy> thenByQuestIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'questId', Sort.desc);
    });
  }
  ...
  QueryBuilder<UserProgress, UserProgress, QAfterSortBy> thenByUuid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.asc);
    });
  }

  QueryBuilder<UserProgress, UserProgress, QAfterSortBy> thenByUuidDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.desc);
    });
  }
...
extension UserProgressQueryWhereDistinct
  ...
  QueryBuilder<UserProgress, UserProgress, QDistinct> distinctByQuestId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProgress, UserProgress, QDistinct> distinctByUuid(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserProgressQueryProperty
  ...
  QueryBuilder<UserProgress, DateTime, QQueryOperations> completedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'completedAt');
    });
  }

  QueryBuilder<UserProgress, String, QQueryOperations> questIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProgress, String, QQueryOperations> uuidProperty() {
    return QueryBuilder.apply(this, (query) {
