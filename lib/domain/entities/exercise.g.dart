...
const ExerciseSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isPremiumLocked': PropertySchema(
      id: 2,
      name: r'isPremiumLocked',
      type: IsarType.bool,
    ),
...
void _exerciseSerialize(
  ...
  writer.writeBool(offsets[2], object.isPremiumLocked);
  writer.writeStringList(offsets[3], object.prerequisites);
...
Exercise _exerciseDeserialize(
  ...
  final object = Exercise(
    ...
    id: id,
    isPremiumLocked: reader.readBoolOrNull(offsets[2]) ?? false,
    prerequisites: reader.readStringList(offsets[3]) ?? const [],
...
extension ExerciseQueryFilter
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition>
      isPremiumLockedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isPremiumLocked',
        value: value,
      ));
    });
  }
...
extension ExerciseQuerySortBy on QueryBuilder<Exercise, Exercise, QSortBy> {
  ...
  QueryBuilder<Exercise, Exercise, QAfterSortBy> sortByIsPremiumLocked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPremiumLocked', Sort.asc);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterSortBy> sortByIsPremiumLockedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPremiumLocked', Sort.desc);
    });
  }
...
extension ExerciseQuerySortThenBy
  ...
  QueryBuilder<Exercise, Exercise, QAfterSortBy> thenByIsPremiumLocked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPremiumLocked', Sort.asc);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterSortBy> thenByIsPremiumLockedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPremiumLocked', Sort.desc);
    });
  }
...
extension ExerciseQueryWhereDistinct
  ...
  QueryBuilder<Exercise, Exercise, QDistinct> distinctByIsPremiumLocked() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isPremiumLocked');
    });
  }

  QueryBuilder<Exercise, Exercise, QDistinct> distinctByPrerequisites() {
    return QueryBuilder.apply(this, (query) {
...
extension ExerciseQueryProperty
  ...
  QueryBuilder<Exercise, bool, QQueryOperations> isPremiumLockedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isPremiumLocked');
    });
  }
