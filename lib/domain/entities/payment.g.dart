...
void _paymentSerialize(
  ...
  writer.writeLong(offsets[2], object.orderCode);
...
Payment _paymentDeserialize(
  ...
  final object = Payment(
    ...
    id: id,
    orderCode: reader.readLong(offsets[2]),
...
extension PaymentQueryFilter
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> orderCodeEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> orderCodeGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> orderCodeLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> orderCodeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> userIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> userIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> userIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> userIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> userIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userId',
        value: '',
  ...
  QueryBuilder<Payment, Payment, QAfterFilterCondition> userIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'userId',
        value: '',
...
extension PaymentQuerySortBy on QueryBuilder<Payment, Payment, QSortBy> {
  ...
  QueryBuilder<Payment, Payment, QAfterSortBy> sortByOrderCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderCode', Sort.asc);
    });
  }

  QueryBuilder<Payment, Payment, QAfterSortBy> sortByOrderCodeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PaymentQuerySortThenBy
  ...
  QueryBuilder<Payment, Payment, QAfterSortBy> thenByOrderCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderCode', Sort.asc);
    });
  }

  QueryBuilder<Payment, Payment, QAfterSortBy> thenByOrderCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderCode', Sort.desc);
    });
  }
...
extension PaymentQueryWhereDistinct
  ...
  QueryBuilder<Payment, Payment, QDistinct> distinctByOrderCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'orderCode');
    });
  }
...
extension PaymentQueryProperty
  ...
  QueryBuilder<Payment, int, QQueryOperations> orderCodeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Payment, String, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
