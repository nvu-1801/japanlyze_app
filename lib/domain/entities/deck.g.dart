...
const DeckSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'dueCount': PropertySchema(id: 3, name: r'dueCount', type: IsarType.long),
...
void _deckSerialize(
  ...
  writer.writeLong(offsets[3], object.dueCount);
...
Deck _deckDeserialize(
  ...
  final object = Deck(
    ...
    dueCount: reader.readLongOrNull(offsets[3]) ?? 0,
    id: id,
...
extension DeckQueryFilter on QueryBuilder<Deck, Deck, QFilterCondition> {
  QueryBuilder<Deck, Deck, QAfterFilterCondition> cardCountEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> cardCountGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> cardCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> cardCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> descriptionIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> descriptionIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> dueCountEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'dueCount', value: value),
      );
    });
  }

  QueryBuilder<Deck, Deck, QAfterFilterCondition> dueCountGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> dueCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> dueCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> titleContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> titleMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> updatedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> updatedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> userIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension DeckQuerySortBy on QueryBuilder<Deck, Deck, QSortBy> {
  QueryBuilder<Deck, Deck, QAfterSortBy> sortByCardCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cardCount', Sort.asc);
    });
  }

  QueryBuilder<Deck, Deck, QAfterSortBy> sortByCardCountDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterSortBy> sortByDueCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dueCount', Sort.asc);
    });
  }

  QueryBuilder<Deck, Deck, QAfterSortBy> sortByDueCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dueCount', Sort.desc);
    });
  }
...
extension DeckQuerySortThenBy on QueryBuilder<Deck, Deck, QSortThenBy> {
  QueryBuilder<Deck, Deck, QAfterSortBy> thenByCardCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cardCount', Sort.asc);
    });
  }

  QueryBuilder<Deck, Deck, QAfterSortBy> thenByCardCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cardCount', Sort.desc);
    });
  }
  ...
  QueryBuilder<Deck, Deck, QAfterSortBy> thenByDueCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dueCount', Sort.asc);
    });
  }

  QueryBuilder<Deck, Deck, QAfterSortBy> thenByDueCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dueCount', Sort.desc);
    });
  }
...
extension DeckQueryWhereDistinct on QueryBuilder<Deck, Deck, QDistinct> {
  QueryBuilder<Deck, Deck, QDistinct> distinctByCardCount() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QDistinct> distinctByDueCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dueCount');
    });
  }
...
extension DeckQueryProperty on QueryBuilder<Deck, Deck, QQueryProperty> {
  ...
  QueryBuilder<Deck, int, QQueryOperations> cardCountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, int, QQueryOperations> dueCountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'dueCount');
    });
  }
  ...
  QueryBuilder<Deck, int, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
