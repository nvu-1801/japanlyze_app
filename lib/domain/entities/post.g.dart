...
Post _postDeserialize(
  ...
  final object = Post(
    ...
    id: id,
    rating: reader.readLongOrNull(offsets[2]) ?? 5,
...
extension PostQueryFilter on QueryBuilder<Post, Post, QFilterCondition> {
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> ratingEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'rating',
        value: value,
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> ratingGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> ratingLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> ratingBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> userIdContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'userId',
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> userIdMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'userId',
...
extension PostQuerySortBy on QueryBuilder<Post, Post, QSortBy> {
  ...
  QueryBuilder<Post, Post, QAfterSortBy> sortByRating() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.asc);
    });
  }

  QueryBuilder<Post, Post, QAfterSortBy> sortByRatingDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PostQuerySortThenBy on QueryBuilder<Post, Post, QSortThenBy> {
  ...
  QueryBuilder<Post, Post, QAfterSortBy> thenByRating() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.asc);
    });
  }

  QueryBuilder<Post, Post, QAfterSortBy> thenByRatingDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.desc);
    });
  }
...
extension PostQueryWhereDistinct on QueryBuilder<Post, Post, QDistinct> {
  ...
  QueryBuilder<Post, Post, QDistinct> distinctByRating() {
    return QueryBuilder.apply(this, (query) {
...
extension PostQueryProperty on QueryBuilder<Post, Post, QQueryProperty> {
  ...
  QueryBuilder<Post, int, QQueryOperations> ratingProperty() {
    return QueryBuilder.apply(this, (query) {
